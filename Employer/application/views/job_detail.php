                        ...
                        <div class="careerfy-column-12">
                            <div class="careerfy-typo-wrap">
                                <figure class="careerfy-jobdetail-list">
                                    <span class="careerfy-jobdetail-listthumb"><img src="<?= base_url()?>/assets/extra-images/job-detail-logo-1.png" alt=""></span>
                                    <figcaption>
                                        <h2>Teacher - High School Level Math, Science & SAT/ACT Prep</h2>
                                        <span> Huntington Learning Center <small class="careerfy-jobdetail-postinfo">Posted now</small></span>
                                        <ul class="careerfy-jobdetail-options">
                                            <li><i class="fa fa-map-marker"></i> New Delhi, Delhi, India <a href="#" class="careerfy-jobdetail-view">View om Map</a></li>
                                            <li><i class="careerfy-icon careerfy-calendar"></i> Post Date: May 18, 2017</li>
                                    ...
                                    <div class="careerfy-jobdetail-services">
                                        <ul class="careerfy-row">
                                            <li class="careerfy-column-4">
                                                ...
                                                <div class="careerfy-services-text">Offerd Salary <small>&#8377 50000</small></div>
                                            </li>
                                            <li class="careerfy-column-4">
